...
(function(){
	...
	if(navigator.geolocation){
		//intentamos obtener las coordenadas del usuario  objPosicion.coords.longitude
		navigator.geolocation.getCurrentPosition(function(objPosicion){
			//almacenamos en variables la longitud y latitud
			var iLongitud=-99.15784400311156, iLatitud=19.526851863306756;
			...
			var objPunto=new google.maps.Marker({
				title:		'Jack Sport Gym ',	//agregamos un tooltip al punto
